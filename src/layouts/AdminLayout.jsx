...
import "../admin/pages/AdminHomepage/index.css";
...
export default function AdminLayout() {
  ...
  const accountMenuItems = [{ key: "profile", label: "Account Settings" }];
  const onAccountMenuClick = ({ key }) => { if (key === 'profile') navigate('/admin/profile'); };
